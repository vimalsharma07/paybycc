...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('subservices') && ! Schema::hasTable('sub_services')) {
        ...
        if (! Schema::hasTable('service_submissions')) {
        ...
        if (! Schema::hasTable('seller_subservices') && ! Schema::hasTable('freelancer_services')) {
        ...
        if (! Schema::hasTable('orders') && ! Schema::hasTable('marketplace_orders')) {
        ...
        if (! Schema::hasTable('settlements') && ! Schema::hasTable('marketplace_settlements')) {
    ...
    public function down(): void
    {
        ...
        $existing = array_filter($columns, fn (string $col) => Schema::hasColumn('users', $col));
