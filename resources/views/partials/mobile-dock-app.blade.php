...
@if (! $isAdmin)
    <nav class="mobile-dock fixed bottom-0 left-0 right-0 z-50 border-t border-slate-200/90 bg-white/95 backdrop-blur-md lg:hidden mobile-dock-safe" aria-label="App navigation">
        ...
        @else
            <div class="relative mx-auto flex min-h-[4.75rem] max-w-lg items-end justify-between px-4 pb-1.5 pt-8">
                ...
                <a href="{{ $payHref }}" class="mobile-dock-fab absolute bottom-full left-1/2 z-[51] mb-1.5 flex h-[3.25rem] w-[3.25rem] -translate-x-1/2 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 via-indigo-600 to-violet-600 text-xs font-extrabold text-white shadow-lg shadow-indigo-500/40 ring-4 ring-white transition hover:brightness-110 active:scale-95" aria-label="Complete KYC">
                    KYC
                </a>
