...
@section('guest_hero')
    ...
    <p class="max-w-md text-sm leading-relaxed text-slate-400">Accept business payments online — UPI, cards, net banking, KYC, and compliant bank settlements in one place.</p>
@endsection
